...
if (Config.LANG == 'TR' || Config.LANG == 'AZ') {
    ...
    thespy147.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_Des}, (async (message, match) => {
    ...
    thespy147.addCommand({pattern: 'help ?(.*)', fromMe: true, desc: h_DedEN}, (async (message, match) => {
