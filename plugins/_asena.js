...
const Lang = Language.getString('_thespy147');

if (Config.WORKTYPE == 'private') {

    thespy147.addCommand({pattern: 'thespy147 ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {

        var CMD_HELP = '';
        if (match[1] === '') {
            thespy147.commands.map(
                async (command) =>  {
    ...
    thespy147.addCommand({pattern: 'thespy147 ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
