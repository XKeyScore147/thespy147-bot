...
if (pb.WORKTYPE == 'private') {
    thespy147.addCommand({ pattern: '.', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
    ...
    thespy147.addCommand({ pattern: '.', fromMe: false, dontAddCommandList: true }, (async (message, match) => {
        if(message.fromMe) return
        let command = [ 
        'xmedia',
        'install',
